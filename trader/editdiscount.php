...
<?php 
    ...
    if(isset($_POST['update_discount'])){
        ...
        if(updateDiscount($discount_percentage,$discount_amount,$productid)==true){
            $result='<div style=width:50%;position:relative;left:30%; class="alert alert-success">Discount is updated in selected product!!</div>';
            echo $result;
        }
        else{
          echo "error occured";
        ...
        <nav class="navbar navbar-default navbar-fixed">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">Edit Discount</a>
                </div>
...
<section class="Image-sec">
  ...
  <tbody>
    <tr>
      ...
      <td data-column=""><input type="text" class="form-control" name="discount_percentage"   id="name"  placeholder=""></td>
    </tr>
    <tr>
...
<div class="form-group">
                    ...
                    <span> <input style="background:none;border:none;" type="submit" name="update_discount" value="Edit Discount"> </span>
                </div>
                    </div>
                </div> <!-- form-group // -->
		    	</div>
