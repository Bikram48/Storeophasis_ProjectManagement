...
<div class="wrapper">
    <div class="sidebar" data-color="brown" data-image="assets/img/sidebar-3.jpg">
        ...
        <nav class="navbar navbar-default navbar-fixed">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">View All Products</a>
                </div>
  ...
  <?php  if(isset($_SESSION['shid'])){ $shopid=$_SESSION['shid']; $query="select * from product where FK2_SHOPID=$shopid";  
    ...
    <div class="col-xs-12 col-sm-6">
      ...
      <?php echo "<img src=../Images/".$row['IMAGE'].">";?>
        <div class="col-md-5"><h3><?php echo $row['PRODUCTNAME']; ?></h3>
        ...
        <div class="bottom">
            ...
            <?php echo "<a href=UpdateDis.php?productid=".$row['PRODUCTID']."><button class='btn-3'>Add Discount</button></a>"; ?>
        </div>
      </div>
    </div>
         <?php } } ?>
