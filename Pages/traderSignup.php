<?php
    if(isset($_POST['submit'])){
       ...
       include "../backend/connect.php";
        ...
        $error=$error1=$error2=$error3=$error4=$error5=$error6=$error7=$error8=$error9=$error10=$error11=$error12=$error13="";
        if(empty($username)){
        ...
        elseif(!preg_match("#[\W]+#",$password)){
            ...
            if($count>0){
                ...
                $query="INSERT INTO USERS (USERID,USERNAME,EMAIL,USERROLE,AGE,DATEOFBIRTH,PASSWORD,PHONENUMBER,
                        ...
                        10,(to_date('$dob','dd/mm/yyyy')),'$password','$phone','$verification_code','$verified',
                        '$filename')";
                ...
                if($result){
                   ...
                   $count=oci_num_rows($parse);
                    ...
                    $message="<a href=http://localhost/dashboard/addtocart/storeophasis/pages/verify.php?vkey=".$verification_code."&userid=".$row['USERID']."> Register Account </a>";
...
<body>
    ...
    <div class="sign-up-form">
        <h1>Signup for Trader</h1>
        <form method="post" action="" enctype="multipart/form-data">
            <input type="text" class="input-box" value="<?php if(isset($username)){echo $username;}?>" name='username'  placeholder="Enter Username">
            ...
            <input type="email" class="input-box" value="<?php if(isset($email)){echo $email;} ?>"  name='email'  placeholder="Enter email">
            ...
            <input type="text" class="input-box" value="<?php if(isset($phone)){echo $phone;}  ?>" name='phone_number' placeholder="Enter Phone Number">
            ...
            <input type="text" class="input-box" value="<?php if(isset($dob)){echo $dob;}  ?>" name='dob' placeholder="Enter Date Of Birth">
            ...
            <input type="password" class="input-box" value="<?php if(isset($password)){echo $password;}  ?>" name='pwd' placeholder="Enter Password">
            <span style="font-size:11px;position:absolute;left:40%;color:red;font-weight:bold;font-family: 'Playfair Display', serif;" id="error"><?php if(isset($error4)){echo $error4;} 
            if(isset($error8)){echo $error8;} if(isset($error9)){echo $error9;} if(isset($error10)){echo $error10;} if(isset($error10)){echo $error11;}?></span>
            <input type="password" class="input-box" value="<?php if(isset($confirm_pwd)){echo $confirm_pwd;}  ?>" name='confirm_pwd' placeholder="Confirm Password">
            ...
            <hr>
            <p class="or">OR</p>
            <p>Do you have an account ? <a href="traderLogin.php">Sign in</a></p>
        </form>
    </div>
