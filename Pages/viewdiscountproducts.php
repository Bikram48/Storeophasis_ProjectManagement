...
<div class="wrapper">
  ...
  <table>
    ...
    <tr>
        ...
        <?php echo "<td>".$row['DISCOUNTPERCENTAGE']."</td>" ?>
        <?php echo "<td>".$row['DISCOUNTAMOUNT']."</td>" ?>
...
<button class=btn><a href=../backend/deletediscount.php?productId=".$row['PRODUCTID']."><i class=fas fa-times></i> Delete</a>
</button><button class=btn><a href=editdiscount.php?productId=".$row['PRODUCTID']."><i class=fas fa-eye></i> Edit Discount</a></button></td>"?>
